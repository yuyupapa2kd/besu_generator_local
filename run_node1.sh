...
/opt/besu/bin/besu --data-path=node1 --genesis-file=besu-data/genesis.json --node-private-key-file=node1/keys/key \
    --network-id=2021 --miner-enabled --miner-coinbase=0x2A29e1c0a64a632b640f0a295066B395d13f4b4A \
    --p2p-host=0.0.0.0 --p2p-interface=0.0.0.0 --p2p-port=30304 --host-allowlist="*" \
    --rpc-http-enabled --rpc-http-api=ETH,NET,IBFT,WEB3,TRACE,DEBUG  --rpc-http-cors-origins="all" --rpc-http-port=8547 \
    --rpc-ws-enabled --rpc-ws-port=8548 \
